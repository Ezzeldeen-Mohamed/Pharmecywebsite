...
namespace ePharma_asp_mvc.Migrations
{
    ...
    [Migration("20260514163706_Prescpectionaddress")]
    partial class Prescpectionaddress
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ePharma_asp_mvc.Models.HealthService", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ePharma_asp_mvc.Models.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ePharma_asp_mvc.Models.Prescription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ePharma_asp_mvc.Models.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ePharma_asp_mvc.Models.ServiceRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<decimal>("PriceAtTimeOfRequest")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ePharma_asp_mvc.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ePharma_asp_mvc.Models.OrderItem", b =>
                {
                    b.HasOne("ePharma_asp_mvc.Models.Order", "Order")
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("ePharma_asp_mvc.Models.ServiceRequest", b =>
                {
                    b.HasOne("ePharma_asp_mvc.Models.HealthService", "Service")
                        .WithMany()
